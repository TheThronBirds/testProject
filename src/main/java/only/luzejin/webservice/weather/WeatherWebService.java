 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/workSpace/testProject/src/main/java/only/luzejin/webservice/weather/webservice.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/workSpace/testProject/src/main/java/only/luzejin/webservice/weather/webservice.wsdl");
